...
def test_apply_move_all_cards_onto_empty_page_emits_two_page_type_changed_signals(qtbot, document_light):
    ActionNewPage().apply(document_light)
...
def test_apply_move_all_cards_onto_partially_filled_page_emits_one_page_type_changed_signal(qtbot, document_light):
    ActionNewPage().apply(document_light)
...
def test_apply_move_subset_of_cards_onto_empty_page_emits_one_page_type_changed_signals(qtbot, document_light):
    ActionNewPage().apply(document_light)
    to_move = append_new_card_in_page(document_light.pages[0], "Move")
...
def test_apply_move_subset_of_cards_onto_partially_filled_page_emits_no_page_type_changed_signals(
