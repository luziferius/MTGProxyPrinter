...
def test_update_only_updates_relevant_printing_preferences(card_db: CardDatabase):
    ...
    db = card_db.db
    weights = {("hide-universes-beyond-cards", 5)}
    ...
    assert_that(
        ...
        contains_exactly(
            ("7ef83f4c-d3ff-4905-a16d-f2bae673a5b2", 0),
            ("815261f8-daaa-4d76-86d9-d2801eb3f1f7", 5),
            ("ffa13d4c-6c5e-44bd-859e-38e79d47a916", 0),
        )
    )
