...
class Application(QApplication):
    ...
    def enqueue_startup_tasks(self, args: Namespace):
        ...
        if settings.was_application_updated():
            logger.info(
                f'Updated application from {settings.settings.general.last_used_version} '
    ...
    def _check_for_undecided_update_settings(self):
        ...
        if general.check_for_application_updates is None:
        ...
        if general.check_for_card_data_updates is None:
