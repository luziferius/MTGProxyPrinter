...
try:
    from mtg_proxy_printer.ui.generated.cache_cleanup_wizard.printing_filter_page import Ui_CardFilterPage
    ...
    Ui_CardFilterPage = load_ui_from_file("cache_cleanup_wizard/printing_filter_page")
