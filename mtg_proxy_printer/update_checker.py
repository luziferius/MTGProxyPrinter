...
class UpdateChecker(QObject):
    ...
    def check_for_updates(self):
        app_settings = settings.settings.general
        if app_settings.check_for_application_updates:
        ...
        if not self.card_data_parameter_passed and app_settings.check_for_card_data_updates:
