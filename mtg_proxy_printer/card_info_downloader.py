...
class CardInfoDownloader(QObject):
    ...
    def __init__(self, model: mtg_proxy_printer.model.carddb.CardDatabase,
        ...
        self.request_import_from_file.connect(self.database_import_worker.download_card_data)
        self.request_import_from_url.connect(self.database_import_worker.download_card_data)
