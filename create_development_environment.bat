...
del QtHelp.pyd QtHelp.pyi QtLocation.pyd QtLocation.pyi QtMultimedia.pyd QtMultimedia.pyi QtMultimediaWidgets.pyd
del QtMultimediaWidgets.pyi QtOpenGL.pyd QtOpenGL.pyi QtNfc.pyd QtNfc.pyi QtPositioning.pyd QtPositioning.pyi
